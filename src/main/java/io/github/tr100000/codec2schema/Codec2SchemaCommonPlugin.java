...
public class Codec2SchemaCommonPlugin implements Codec2SchemaPlugin {
    ...
    public void generateSchemas(SchemaExporter exporter) {
        ...
        exportDataCodec(exporter, BlockTransformer.DIRECT_CODEC, "block_transformer.json");
        ...
        exportDataWorldgenCodec(exporter, MaterialCondition.DIRECT_CODEC, "material_condition.json");
